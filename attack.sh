...
function attack {
        ...
        tmux select-window -t attack & tmux send-keys -t 0 "$command" Enter & sleep 20 && tmux send-keys -t 0 C-c Enter && sleep 900 && tmux send-keys -t 0 "systemctl restart docker.service" Enter
}
